"""
Cart Checkout Service - Handles cart operations and payment flow
Manages cart calculations, payment link generation, and customer notifications
"""
...
class CartCheckoutService:
    """Service for handling cart checkout operations"""
    ...
    def calculate_order_total(self, order_id: str) -> Dict[str, Any]:
        ...
        Returns:
            Dict containing order calculation details
        """
        try:
    ...
    async def generate_payment_link_for_order(
        ...
        Args:
            ...
            customer_wa_id: Customer WhatsApp ID
            customer_name: Customer name (optional)
            customer_email: Customer email (optional)
            customer_phone: Customer phone (optional)
            
        Returns:
            Dict containing payment generation result
        """
        try:
            ...
            payment = self.payment_service.create_payment_link(payment_data, mock=False)
            ...
            error_msg = str(e)
            print(f"[CART_CHECKOUT] Unexpected error: {error_msg}")
            return {"error": f"Payment generation failed: {error_msg}", "success": False, "error_type": "unknown"}
...
Click the payment link above to redirect to Razorpay's secure payment page. Thank you! 🙏"""
    ...
    def get_order_summary_for_payment(self, order_id: str) -> Dict[str, Any]:
        ...
        Returns:
            Dict containing formatted order summary
        """
